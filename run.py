...
def main():
    ...
    # Ridge Regression
    w_ridge, _ = ridge_regression(y, x_aug_expand, lambd)
    ...
    x_test_aug, _, _ = fea_augmentation(x_test_std, method=['polynomial', 'neg_polynomial', 'missing_value_indicator',
    ...
    y_pred = predict_labels(x_test_aug_expand, w_ridge, method='linear')
